...
for line in input.splitlines():
    ...
    line = line.split(' ')
    pos = line[0].removeprefix('p=').split(',')
    vel = line[1].removeprefix('v=').split(',')
...
with open(OUT_FILEPATH, 'w') as file:
    ...
    file.write("\n")
    file.write(f"#define ROBOT_COUNT ({len(robots)})\n")

    file.write(f"{STRUCT}\n")

    file.write("static const robots_t ROBOTS = {{\n")
    for robot in robots:
        file.write(f"    {{ {{ {robot[0]}, {robot[1]} }}, {{ {robot[2]}, {robot[3]} }} }},\n")
    file.write("}};\n")
